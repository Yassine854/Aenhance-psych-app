...
<template>
    ...
    <div class="relative w-full h-[180px] overflow-hidden">
        <div
            ...
            style="
                background-image: url(&quot;/storage/banners/banner1.jpg&quot;);
            "
        >
            <div
                class="absolute inset-0 bg-gradient-to-r from-[#5997ac]/80 to-[#e8b4b8]/80"
            ></div>
        </div>

        <div
            class="relative h-full flex flex-col justify-center container mx-auto px-4 sm:px-6 lg:px-8"
        >
            ...
            <div class="grid grid-cols-1 lg:grid-cols-4 gap-8">
                ...
                <div class="lg:col-span-3">
                    <div class="bg-white rounded-lg shadow-sm p-6 md:p-8">
                        ...
                        <section class="mb-8">
                            <h2
                                class="text-2xl md:text-3xl font-bold text-[#5997ac] mb-4"
                            >
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                >
                                    <div class="flex items-start gap-3 mb-2">
                                        <div
                                            class="flex-shrink-0 w-10 h-10 bg-[#5997ac] rounded-full flex items-center justify-center"
                                        >
                                            <svg
                                        ...
                                        <div>
                                            ...
                                            >
                                                {{
                                                    t(
                                                        "whoWeAre.values.accessibility.title",
                                                    )
                                                }}
                                            </h3>
                                            <p
                                            ...
                                            >
                                                {{
                                                    t(
                                                        "whoWeAre.values.accessibility.description",
                                                    )
                                                }}
                                            </p>
                                        </div>
                                ...
                                >
                                    <div class="flex items-start gap-3 mb-2">
                                        <div
                                            class="flex-shrink-0 w-10 h-10 bg-[#af5166] rounded-full flex items-center justify-center"
                                        >
                                            <svg
                                                class="w-6 h-6 text-white"
                                                fill="currentColor"
                                        ...
                                        <div>
                                            ...
                                            >
                                                {{
                                                    t(
                                                        "whoWeAre.values.qualityCare.title",
                                                    )
                                                }}
                                            </h3>
                                            <p
                                            ...
                                            >
                                                {{
                                                    t(
                                                        "whoWeAre.values.qualityCare.description",
                                                    )
                                                }}
                                            </p>
                                        </div>
                                    ...
                                    <div class="flex items-start gap-3 mb-2">
                                        ...
                                        <div>
                                            ...
                                            >
                                                {{
                                                    t(
                                                        "whoWeAre.values.privacy.description",
                                                    )
                                                }}
                                            </p>
                                        </div>
                                    ...
                                    <div class="flex items-start gap-3 mb-2">
                                        ...
                                        <div>
                                            ...
                                            >
                                                {{
                                                    t(
                                                        "whoWeAre.values.empathy.description",
                                                    )
                                                }}
                                            </p>
                                        </div>
                                    ...
                                    <div class="flex items-start gap-3 mb-2">
                                        ...
                                        <div>
                                            ...
                                            >
                                                {{
                                                    t(
                                                        "whoWeAre.values.innovation.title",
                                                    )
                                                }}
                                            </h3>
                                            <p
                                            ...
                                            >
                                                {{
                                                    t(
                                                        "whoWeAre.values.innovation.description",
                                                    )
                                                }}
                                            </p>
                                        </div>
                                    ...
                                    <div class="flex items-start gap-3 mb-2">
                                        ...
                                        <div>
                                            ...
                                            >
                                                {{
                                                    t(
                                                        "whoWeAre.values.community.title",
                                                    )
                                                }}
                                            </h3>
                                            <p
                                            ...
                                            >
                                                {{
                                                    t(
                                                        "whoWeAre.values.community.description",
                                                    )
                                                }}
                                            </p>
                                        </div>
                            ...
                            <div class="space-y-6">
                                ...
                                >
                                    <div class="flex items-start gap-4">
                                        <div
                                            class="flex-shrink-0 w-10 h-10 bg-[#5997ac] rounded-full flex items-center justify-center text-white font-bold text-lg"
                                        >
                                            1
                                        </div>
                                        <div>
                                            <h3
                                                class="text-lg font-bold text-[#5997ac] mb-2"
                                            >
                                                {{
                                                    t(
                                                        "whoWeAre.objectives.objective1.title",
                                                    )
                                                }}
                                            </h3>
                                            <p
                                            ...
                                            >
                                                {{
                                                    t(
                                                        "whoWeAre.objectives.objective1.description",
                                                    )
                                                }}
                                            </p>
                                        </div>
                                ...
                                >
                                    <div class="flex items-start gap-4">
                                        <div
                                            class="flex-shrink-0 w-10 h-10 bg-[#af5166] rounded-full flex items-center justify-center text-white font-bold text-lg"
                                        >
                                            2
                                        </div>
                                        <div>
                                            <h3
                                                class="text-lg font-bold text-[#af5166] mb-2"
                                            >
                                                {{
                                                    t(
                                                        "whoWeAre.objectives.objective2.title",
                                                    )
                                                }}
                                            </h3>
                                            <p
                                            ...
                                            >
                                                {{
                                                    t(
                                                        "whoWeAre.objectives.objective2.description",
                                                    )
                                                }}
                                            </p>
                                        </div>
                                    ...
                                    <div class="flex items-start gap-4">
                                        ...
                                        <div>
                                            ...
                                            >
                                                {{
                                                    t(
                                                        "whoWeAre.objectives.objective3.title",
                                                    )
                                                }}
                                            </h3>
                                            <p
                                            ...
                                            >
                                                {{
                                                    t(
                                                        "whoWeAre.objectives.objective3.description",
                                                    )
                                                }}
                                            </p>
                                        </div>
                                    ...
                                    <div class="flex items-start gap-4">
                                        ...
                                        <div>
                                            ...
                                            >
                                                {{
                                                    t(
                                                        "whoWeAre.objectives.objective4.title",
                                                    )
                                                }}
                                            </h3>
                                            <p
                                            ...
                                            >
                                                {{
                                                    t(
                                                        "whoWeAre.objectives.objective4.description",
                                                    )
                                                }}
                                            </p>
                                        </div>
                                    ...
                                    <div class="flex items-start gap-4">
                                        ...
                                        <div>
                                            ...
                                            >
                                                {{
                                                    t(
                                                        "whoWeAre.objectives.objective5.title",
                                                    )
                                                }}
                                            </h3>
                                            <p
                                            ...
                                            >
                                                {{
                                                    t(
                                                        "whoWeAre.objectives.objective5.description",
                                                    )
                                                }}
                                            </p>
                                        </div>
...
<div class="bg-white rounded-lg shadow-sm p-6 mb-6">
  ...
  <ul class="space-y-2">
    ...
    <li>
      <Link href="/who-we-are" class="flex items-center gap-2 text-[#af5166] font-semibold py-2 transition-colors">
        <span class="text-[#af5166]">›</span>
