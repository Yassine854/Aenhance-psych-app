      ...
      <div class="bg-gradient-to-r from-[rgb(141,61,79)] to-[rgb(89,151,172)] p-6">
        <div class="flex items-center justify-between">
          <div class="text-white">
            <div class="text-xl font-semibold">Add Expertise</div>
            <div class="text-sm opacity-90">Create a new expertise</div>
          </div>
...
async function submitCreate() {
  ...
  try {
    ...
    const res = await fetch('/expertises', {
      method: 'POST',
    ...
    generalError.value = text || 'Failed to create expertise.'
  } catch (e) {
    generalError.value = e?.message || 'Failed to create expertise.'
  } finally {
    creating.value = false
  }
}
